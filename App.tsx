...
const MessageList = ({ onSelectChat, onBack }: { onSelectChat: () => void, onBack: () => void }) => {
  ...
  return (
    <div className="h-full bg-white font-patrick flex flex-col">
       <div className="p-4 border-b-2 border-black flex justify-between items-end pb-2">
          <button onClick={onBack} className="text-black font-bold text-lg flex items-center gap-1"><ChevronLeft size={20} strokeWidth={2.5}/> Back</button>
  ...
  return (
    <div className="fixed inset-0 w-full bg-black overflow-hidden" style={{ height: viewportHeight }}>
      <div className="w-full h-full bg-white relative overflow-hidden font-patrick">
        ...
        {currentApp === 'messages' && <MessageList onSelectChat={() => setCurrentApp('active_chat')} onBack={() => setCurrentApp('home')} />}
